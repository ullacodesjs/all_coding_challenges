...
// 3. Bonus1: Include a requirement for a minimum score of 100. With this rule,
...
// and returns the corresponding tip, calculated based on the rules above (you can check out the code from first tip calculator challenge if you need to).
